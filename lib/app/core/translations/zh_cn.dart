const Map<String, String> zhCN = {
  // App
  'app_name': '图片整理',
  'app_subtitle': '快速浏览、分类和管理你的图片',

  // Features
  'feature_drag': '拖拽整理',
  'feature_rename': '自动命名',
  'feature_preview': '缩略图预览',
  ...
  'language': '语言',
  'browse_mode': '浏览模式',
  'thumbnail_mode': '缩略图模式',
  'thumbnail_mode_desc': '为大文件夹后台生成并使用缩略图，提升滚动与切换流畅度',
  'lang_en': 'English',
  'lang_zh_cn': '简体中文',
  'lang_zh_tw': '繁體中文',
  'close': '关闭',
  ...
  'folder_delete_warning': '文件夹 "@name" 及其所有内容将移入回收站',
  'image_delete_warning': '图片 "@name" 将移入回收站',
  ...
  'image_renamed': '重命名成功',
  'image_deleted': '删除成功',
  'deleted_count': '已删除 @count 张图片',
  'moved_count': '已移动 @count 张图片',
  'imported_count': '已导入 @count 张图片',
