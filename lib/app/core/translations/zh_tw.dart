const Map<String, String> zhTW = {
  // App
  'app_name': '圖片整理',
  'app_subtitle': '快速瀏覽、分類和管理你的圖片',

  // Features
  'feature_drag': '拖曳整理',
  'feature_rename': '自動命名',
  'feature_preview': '縮圖預覽',
  ...
  'browse_mode': '瀏覽模式',
  'thumbnail_mode': '縮圖模式',
  'thumbnail_mode_desc': '為大資料夾背景產生並使用縮圖，提升捲動與切換流暢度',
  'lang_en': 'English',
  'lang_zh_cn': '简体中文',
  'lang_zh_tw': '繁體中文',
  'close': '關閉',
  ...
  'back_home': '返回首頁',
  'root': '根目錄',
  'folders_count': '@count 個資料夾',
  'no_subfolders': '沒有子資料夾',
  'new_folder': '新建資料夾',
  'create_folder': '新建資料夾',
  'enter_folder_name': '輸入資料夾名稱',
  'cancel': '取消',
  'create': '建立',
